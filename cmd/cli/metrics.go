...
const customapiMetrics = "/customapi/metrics"
...
func NewMetricsCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "metrics",
		Short: "Get metrics from an instance via port-forward to /customapi/metrics",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			body, err := client.PortForwardAndRequest(ctx, pod.Name, kube.HTTPPortNumber, customapiMetrics, query)
			if err != nil {
				return err
			}
